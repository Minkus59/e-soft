...
if (isset($_GET['id'])) { ?>
      ...
      <input type="text" placeholder="Libelé du bouton" name="libele" require="required" value="<?php echo $Actu->libele; ?>"><BR /><BR />
      <input type="text" class="GoogleTitre" maxlength="70" placeholder="Titre de la page" name="titre" value="<?php echo $Actu->titre; ?>"><BR /><BR />
      <input type="text" class="GoogleDescription" maxlength="170" placeholder="Description de la page" name="description"value="<?php echo $Actu->description; ?>"><BR /><BR />
